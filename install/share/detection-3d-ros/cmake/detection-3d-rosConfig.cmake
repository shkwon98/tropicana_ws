...
if(detection-3d-ros_CONFIG_INCLUDED)
  return()
endif()
set(detection-3d-ros_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("FALSE" STREQUAL "TRUE")
  set(detection-3d-ros_SOURCE_PREFIX /home/shkwon98/tropicana_ws/src/detection-3d-ros/detection-3d-ros)
  set(detection-3d-ros_DEVEL_PREFIX /home/shkwon98/tropicana_ws/devel)
  set(detection-3d-ros_INSTALL_PREFIX "")
  set(detection-3d-ros_PREFIX ${detection-3d-ros_DEVEL_PREFIX})
else()
  set(detection-3d-ros_SOURCE_PREFIX "")
  set(detection-3d-ros_DEVEL_PREFIX "")
  set(detection-3d-ros_INSTALL_PREFIX /home/shkwon98/tropicana_ws/install)
  set(detection-3d-ros_PREFIX ${detection-3d-ros_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'detection-3d-ros' is deprecated")
...
set(detection-3d-ros_FOUND_CATKIN_PROJECT TRUE)
...
if(NOT "include;/usr/include/pcl-1.8;/usr/include/eigen3;/usr/include;/usr/include/ni;/usr/include/openni2;/usr/include/vtk-6.3;/usr/include/freetype2;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent/include;/usr/lib/x86_64-linux-gnu/openmpi/include;/usr/include/python2.7;/usr/include/x86_64-linux-gnu;/usr/include/hdf5/openmpi;/usr/include/libxml2;/usr/include/jsoncpp;/usr/include/tcl;/usr/include/opencv " STREQUAL " ")
  set(detection-3d-ros_INCLUDE_DIRS "")
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    list(APPEND detection-3d-ros_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/shkwon98/tropicana_ws/install/lib;/home/shkwon98/tropicana_ws/devel/lib;/opt/ros/melodic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(detection-3d-ros_LIBRARY_DIRS ${lib_path})
      list(APPEND detection-3d-ros_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'detection-3d-ros'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND detection-3d-ros_LIBRARIES ${lib})
    endif()
  endif()
...
set(detection-3d-ros_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${detection-3d-ros_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()

set(depends "roscpp;std_msgs;sensor_msgs;cv_bridge;pcl_ros;geometry_msgs;actionlib;actionlib_msgs;darknet_ros_msgs")
foreach(depend ${depends})
  string(REPLACE " " ";" depend_list ${depend})
  # the package name of the dependency must be kept in a unique variable so that it is not overwritten in recursive calls
  list(GET depend_list 0 detection-3d-ros_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${detection-3d-ros_dep}_FOUND)
      find_package(${detection-3d-ros_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${detection-3d-ros_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(detection-3d-ros_INCLUDE_DIRS ${${detection-3d-ros_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(detection-3d-ros_LIBRARIES ${detection-3d-ros_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${detection-3d-ros_dep}_LIBRARIES})
  _list_append_deduplicate(detection-3d-ros_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(detection-3d-ros_LIBRARIES ${detection-3d-ros_LIBRARIES})

  _list_append_unique(detection-3d-ros_LIBRARY_DIRS ${${detection-3d-ros_dep}_LIBRARY_DIRS})
  list(APPEND detection-3d-ros_EXPORTED_TARGETS ${${detection-3d-ros_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${detection-3d-ros_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
